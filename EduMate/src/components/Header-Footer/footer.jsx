    ...
    <div className="bg-[--secondary] text-black py-4 text-center  " style={{ width: "100vw", margin: 0 }}>
      ...
      <div className=" w-full text-center ">
        ...
        <p className="text-sm mt-2">
          Disclaimer: This website is for demonstration of EduMate and does not represent real services or offers. It is intended solely for showcasing the capabilities of the EduMate platform. Any resemblance to actual products, services, or events is purely coincidental
        </p>
        <div className="mt-4">
